...
export function CheckoutScreen({ customers: initialCustomers }: { customers: Customer[] }) {
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-line bg-white p-3.5">
        ...
        <label className="flex items-center gap-2.5">
          ...
          <input
            ...
            inputMode="numeric"
            placeholder="0"
            className="w-[110px] rounded-[10px] border border-line px-2.5 py-2 text-right text-[13.5px] font-bold text-ink"
          />
        </label>
      ...
      <Sheet open={pickerOpen} onClose={() => setPickerOpen(false)}>
        ...
        <div className="flex flex-col gap-2 rounded-[14px] border border-dashed border-primary-light p-3">
          ...
          <input
            ...
            className="rounded-[10px] border border-line px-3 py-2 text-[13.5px]"
          />
          <input
            value={newPhone}
